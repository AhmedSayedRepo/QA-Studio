...
class Installer:
    def __init__(self, root):
        ...
        self.btn = tk.Button(footer, text="Install QA Studio", bg=VIOLET, fg="white",
    ...
    def start_install(self):
        self._running = True
        self.btn.config(state="disabled", text="Installing\u2026", bg="#C9C2E8",
    ...
    def _done(self):
        ...
        self.btn.config(state="normal", text="Launch QA Studio  \u2192", bg=GREEN,
                       activebackground=GREEN_H, disabledforeground="white")
