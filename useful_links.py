...
def screen(app):
        ...
        name_field = ft.TextField(
            ...
            hint_text=strings.t("links_name_hint"), text_size=14, border_color=T.BORDER,
        ...
        def _add(e=None):
            ...
            if not u:
                app._toast(strings.t("links_enter_url")); return
        ...
        def _open(u):
            def _o(e):
                try:
                    ...
                    app._toast(strings.t("links_open_failed"))
            return _o
        ...
        def _open_btn(u):
            return ft.FilledButton(
                strings.t("links_open"), icon=ft.Icons.OPEN_IN_NEW, on_click=_open(u), height=40,
        ...
        name_block = ft.Column([field_label(strings.t("links_app_name")),
                                 ft.Container(hover_field(name_field),
                                              width=(None if _mobile else 230),
                                              padding=ft.Padding.only(top=4))],
                                spacing=0, tight=(not _mobile))
        url_block = ft.Column([field_label(strings.t("links_url_label")),
                                ft.Container(hover_field(url_field),
                                             padding=ft.Padding.only(top=4))],
                               spacing=0, expand=True)
        save_btn = green_btn(strings.t("links_save_changes") if editing else strings.t("links_add_link"),
        ...
        if _mobile:
            ...
            if editing:
                form_items.append(ghost_btn(strings.t("links_cancel"), on_click=_cancel_edit, height=44))
            ...
            if editing:
                form_row.append(ghost_btn(strings.t("links_cancel"), on_click=_cancel_edit, height=44))
        ...
        add_card = card(ft.Column([
            ft.Row([
                ...
                ft.Text(strings.t("links_edit_link") if editing else strings.t("links_add_a_link"), size=16,
        ...
        for i, l in enumerate(app._links):
            ...
            name_row = [ft.Text(nm, size=14.5, weight=ft.FontWeight.BOLD, color=T.INK,
                                 no_wrap=True)]
            if is_static:
                name_row.append(badge(strings.t("links_official"), kind="violet"))
            ...
            if not is_static or is_admin:
                if is_static:
                    trailing.append(ft.IconButton(
                        ...
                        tooltip=strings.t("links_edit"), on_click=_edit_static(l.get("id")),
                        style=ft.ButtonStyle(shape=ft.RoundedRectangleBorder(radius=8))))
                trailing.append(ft.IconButton(
                    ft.Icons.DELETE_OUTLINE, icon_size=18, icon_color=T.INK_3,
                    tooltip=strings.t("links_remove"), on_click=_del(i),
                    style=ft.ButtonStyle(shape=ft.RoundedRectangleBorder(radius=8))))
        ...
        if rows:
            ...
            listing = ft.Container(
                ft.Column([
                    ...
                    ft.Text(strings.t("links_no_links"), size=15, weight=ft.FontWeight.BOLD,
                            color=T.INK),
                    ft.Text(strings.t("links_empty_desc"), size=13, color=T.INK_2,
        ...
        body = ft.Column([
            ...
            ft.Row([ft.Text(strings.t("links_saved_links"), size=10.5, weight=ft.FontWeight.BOLD,
                            color=T.INK_3),
                    ft.Container(expand=True),
                    ft.Text((strings.t("links_count_one", n=len(app._links)) if len(app._links) == 1 else strings.t("links_count_many", n=len(app._links))),
        ...
        return app.shell(
            strings.t("links_title"),
            strings.t("links_subtitle"), body)
